...
private Deque<Weblink> queue = new ArrayDeque<>();
	...
	public static void main(String[] args) {
		...
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2000, "Nested Classes", "https://docs.oracle.com/javase/tutorial/java/javaOO/nested.html","httpz://docs.oracle.com"));
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2001,"Java SE Downloads", "https://www.oracle.com/technetwork/java/javase/downloads/index.html","http://www.oracle.com"));
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2002, "Interface vs Abstract Class", "https://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com"));
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2004, "Virtual Hosting and Tomcat", "https://tomcat.apache.org/tomcat-6.0-doc/virtual-hosting-howto.html", "http://tomcat.apache.org"));
